...
####This will tell us What groups contribute most of these SNPs:

####The ZMMIL, ZMMLR and ZMPBA contribute the most to the SNP count.
...
###assign all missing values as NA, 
###Create a new columns to indicate whether a particular site is homozygous, has the same ###nucleotide on both chromosomes (i.e., A/A, C/C, G/G, T/T) or heterozygous. 
...
###We will construch  scatter plot. 
